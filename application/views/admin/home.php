                                    ...
                                    <table class="table product-overview">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>#85457898</td>
                                                <td>
                                                    <img src="<?php echo base_url(); ?>include_files/admin/plugins/images/chair.jpg" alt="iMac" width="80">
                                                </td>
                                                <td>Rounded Chair</td>
                                                <td>20</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#95457898</td>
                                                <td>
                                                    <img src="<?php echo base_url(); ?>include_files/admin/plugins/images/chair2.jpg" alt="iPhone" width="80">
                                                </td>
                                                <td>Wooden Chair</td>
                                                <td>25</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#68457898</td>
                                                <td>
                                                    <img src="<?php echo base_url(); ?>include_files/admin/plugins/images/chair3.jpg" alt="apple_watch" width="80">
                                                </td>
                                                <td>Gray Chair</td>
                                                <td>12</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#45457898</td>
                                                <td>
                                                    <img src="<?php echo base_url(); ?>include_files/admin/plugins/images/chair4.jpg" alt="mac_mouse" width="80">
                                                </td>
                        ...
                        <div class="slimscrollright">
                            ...
                            <div class="r-panel-body">
                                ...
                                <ul class="m-t-20 chatonline">
                                    ...
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/genu.jpg" alt="user-img"  class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/ritesh.jpg" alt="user-img"  class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/arijit.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/govinda.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/hritik.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/john.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a></li>
                                    <li><a href="javascript:void(0)"><img src="<?php echo base_url(); ?>include_files/admin/plugins/images/users/pawandeep.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>                    
