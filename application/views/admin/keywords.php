            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="white-box">
                            <button class="fcbtn btn btn-success btn-outline btn-1d pull-right" onclick="window.location.href = '<?php echo base_url(); ?>auth_admin/add_keyword'" >Add Keyword</button>                            
        ...
        <script>
                                $(function () {
                                    var myTable = $('#myTable').DataTable({
                                        "bServerSide": true,
                                        "sAjaxSource": "<?php echo base_url(); ?>auth_admin/get_keywords",
                                        "sServerMethod": "POST",
                                        "info": false,
                                        "fnServerParams":
                                                function (aoData) {
                                        ...
                                        aoColumnDefs: [
                                            ...
                                            },
                                            {
                                                ...
                                                {
                                                    var html = '<a href="<?php echo base_url(); ?>auth_admin/add_keyword/' + full['id'] + '" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> '
