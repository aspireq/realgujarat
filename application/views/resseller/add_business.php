...
<html>
    ...
    <body onbeforeunload="myFunction()">
        <?php echo $header; ?>        
        <div class="loaderwrap" id="gif_image" style="display: none;">
                            ...
                            <form class="form" role="form" method="post" enctype="multipart/form-data" action="" id="business_post">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Mobile No." required name="mobile_no" id="mobile_no" maxlength="10" minlength="10" value="<?php echo (!empty($businessinfo) && $businessinfo['mobile_no'] != "") ? $businessinfo['mobile_no'] : '' ?>" onblur="calculateTotal()">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Mobile No." name="more_mobile_no[]" id="more_mobile_no" maxlength="10" minlength="10" value="<?php echo (!empty($contact) && $contact->mobile_number != "") ? $contact->mobile_number : '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
                                ...
                                <div class="row setup-content" id="step-3">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <button class="btn btn-danger prevBtn btn-lg pull-left" type="button">Previous</button>
                                            <button class="btn btn-success btn-lg pull-right" type="button" id="add_busines" name="add_busines">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <script src="<?php echo base_url(); ?>include_files/resseller/js/resseller.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>include_files/resseller/js/formcalculations.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>include_files/resseller/plugin/imageupload/js/plugins/sortable.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>include_files/resseller/plugin/imageupload/js/fileinput.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>include_files/resseller/plugin/imageupload/themes/explorer/theme.js" type="text/javascript"></script>
